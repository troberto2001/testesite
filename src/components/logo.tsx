...
const Logo = ({ width = 150, ...props }: SVGProps<SVGSVGElement> & { width?: number }) => {
  ...
  return (
    ...
    >
      ...
      <path d="M11.6948 13.3851L10.0637 14.4357L11.1143 12.8046L9.48318 11.7539L11.1143 10.7033L12.7454 11.7539L11.6948 13.3851Z" fill="white" stroke="white" strokeWidth="0.s5"/>
